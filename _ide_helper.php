...
namespace YlsIdeas\FeatureFlags\Facades {
    ...
    class Features {
         ...
         * @static 
         */
        public static function turnOn($gateway, $feature)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->turnOn($gateway, $feature);
        }
         ...
         * @static 
         */
        public static function turnOff($gateway, $feature)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->turnOff($gateway, $feature);
        }
         ...
         * @static 
         */
        public static function noMiddlewares()
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->noMiddlewares();
        }
         ...
         * @static 
         */
        public static function noQueryBuilderMixin()
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->noQueryBuilderMixin();
        }
         ...
         * @static 
         */
        public static function configureDebugging($value = true)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->configureDebugging($value);
        }
         ...
         * @static 
         */
        public static function usesMiddlewares()
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->usesMiddlewares();
        }
         ...
         * @static 
         */
        public static function usesDebugging()
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->usesDebugging();
        }
         ...
         * @static 
         */
        public static function usesQueryBuilderMixin()
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->usesQueryBuilderMixin();
        }
         ...
         * @static 
         */
        public static function callOnExpiredFeatures($expiredFeatures, $handler = null)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->callOnExpiredFeatures($expiredFeatures, $handler);
        }
         ...
         * @static 
         */
        public static function applyOnExpiredHandler($handler)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->applyOnExpiredHandler($handler);
        }
         ...
         * @static 
         */
        public static function extend($driver, $builder)
        {
            /** @var \YlsIdeas\FeatureFlags\Manager $instance */
            return $instance->extend($driver, $builder);
        }
         ...
         * @static 
         */
        public static function assertAccessed($feature, $count = null, $message = '')
        {
            /** @var \YlsIdeas\FeatureFlags\Support\FeatureFake $instance */
            return $instance->assertAccessed($feature, $count, $message);
        }
         ...
         * @static 
         */
        public static function assertNotAccessed($feature, $message = '')
        {
            /** @var \YlsIdeas\FeatureFlags\Support\FeatureFake $instance */
            return $instance->assertNotAccessed($feature, $message);
        }
         ...
         * @static 
         */
        public static function assertAccessedCount($feature, $count = 0, $message = '')
        {
            /** @var \YlsIdeas\FeatureFlags\Support\FeatureFake $instance */
            return $instance->assertAccessedCount($feature, $count, $message);
        }
...
namespace Illuminate\Console\Scheduling {
    ...
    class CallbackEvent {
        ...
        public static function skipWithoutFeature($feature)
        {
            return \Illuminate\Console\Scheduling\CallbackEvent::skipWithoutFeature($feature);
        }
        ...
        public static function skipWithFeature($feature)
        {
            return \Illuminate\Console\Scheduling\CallbackEvent::skipWithFeature($feature);
        }
...
namespace App\Http\Requests {
    ...
    class SlackRequest {
        ...
        public static function validate($rules, ...$params)
        {
            return \App\Http\Requests\SlackRequest::validate($rules, ...$params);
        }
        ...
        public static function validateWithBag($errorBag, $rules, ...$params)
        {
            return \App\Http\Requests\SlackRequest::validateWithBag($errorBag, $rules, ...$params);
        }
        ...
        public static function hasValidSignature($absolute = true)
        {
            return \App\Http\Requests\SlackRequest::hasValidSignature($absolute);
        }
        ...
        public static function hasValidRelativeSignature()
        {
            return \App\Http\Requests\SlackRequest::hasValidRelativeSignature();
        }
        ...
        public static function hasValidSignatureWhileIgnoring($ignoreQuery = [], $absolute = true)
        {
            return \App\Http\Requests\SlackRequest::hasValidSignatureWhileIgnoring($ignoreQuery, $absolute);
        }
        ...
        public static function hasValidRelativeSignatureWhileIgnoring($ignoreQuery = [])
        {
            return \App\Http\Requests\SlackRequest::hasValidRelativeSignatureWhileIgnoring($ignoreQuery);
        }
...
namespace Illuminate\Database\Query {
    ...
    class Builder {
         ...
         * 
         *
         * @see \YlsIdeas\FeatureFlags\Support\QueryBuilderMixin::whenFeatureIsAccessible()
         * @param string $feature
         * @param callable $action
         * @return \Illuminate\Contracts\Database\Query\Builder 
         * @static 
         */
        public static function whenFeatureIsAccessible($feature, $action)
        {
            return \Illuminate\Database\Query\Builder::whenFeatureIsAccessible($feature, $action);
        }

        /**
         * 
         *
         * @see \YlsIdeas\FeatureFlags\Support\QueryBuilderMixin::whenFeatureIsNotAccessible()
         * @param string $feature
         * @param callable $action
         * @return \Illuminate\Contracts\Database\Query\Builder 
         * @static 
         */
        public static function whenFeatureIsNotAccessible($feature, $action)
        {
            return \Illuminate\Database\Query\Builder::whenFeatureIsNotAccessible($feature, $action);
        }
...
namespace  {
    ...
    class Features extends \YlsIdeas\FeatureFlags\Facades\Features {}
}
