...
class AddCustomerToSlackChannel implements ShouldQueue
{
    ...
    public function handle(SlackApi $slackApi)
    {
        ...
        throw_if(is_null($customer->slack_id), "Customer $this->customerId cannot be added to slack channel $this->channel with null slack id!");
        ...
        $slackApi->conversations_invite($customer->slack_id, $channelId);
    }
}
